...
// методы для того чтобы получить элемент документы
...
// убедиться что мы действительно получили элемент в переменную, а не null
...
magicBtn.addEventListener("click", () => {
  ...
  // innerText
  // мы можем обратиться к элементу и обновить значение и свойства
...
// - проверяем - работает ли он - выводим в консоль
